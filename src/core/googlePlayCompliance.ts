export const GOOGLE_PLAY_PRIVACY_DISCLOSURE = [
  ...
  'Health context uses public surveillance and monitoring providers including WHO, CDC, PHAC, Santé publique France, RIVM, ECDC, Eurostat, Our World in Data, and Safecast where available.',
  'Country-level health providers receive only provider-required reporting geography, such as a country code, and do not receive precise coordinates or saved-location names.',
  'Safecast receives the active coordinates and search radius only when AirAware checks for nearby public ambient-radiation measurements.',
  ...
  'AirAware does not send RevenueCat coordinates, environmental readings, health-context readings, Personal Allergy Profile selections, nearby vegetation data, detected events, shared summaries, or notification settings.',
  'AirAware does not send Personal Allergy Profile selections, Activity settings, purchase state, notification preferences, or personal medical information to environmental or health-context providers.',
