...
export function GasMaskIcon({ size = 24, color = '#45BF75', ...props }: GasMaskIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 16 16" fill="none" {...props}>
      <G transform="translate(0,0.9) scale(1.15) translate(-1.05,-0.9)">
        <Path
        ...
        />
        <Circle cx={5.7} cy={5.5} r={1.5} fill="none" stroke={color} strokeWidth={0.9} />
        <Circle cx={10.3} cy={5.5} r={1.5} fill="none" stroke={color} strokeWidth={0.9} />
        <Circle cx={8} cy={9.7} r={2.1} fill="none" stroke={color} strokeWidth={1} />
